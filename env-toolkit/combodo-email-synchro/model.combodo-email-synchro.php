						<?php
//
// File generated by ... on the 2020-06-22T21:44:56-0500
// Please do not edit manually
//

/**
 * Classes and menus for combodo-email-synchro (version 3.2.0)
 *
...
abstract class MailInboxBase extends _MailInboxBase
{
	public static function Init()
	{
		$aParams = array(			'category' => 'searchable,view_in_gui,bizmodel',
			...
			'icon' => utils::GetAbsoluteUrlModulesRoot().'combodo-email-synchro/images/mailbox.png',);
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeString("server", array("allowed_values"=>null, "sql"=>'server', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("mailbox", array("allowed_values"=>null, "sql"=>'mailbox', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeString("login", array("allowed_values"=>null, "sql"=>'login', "default_value"=>'', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributePassword("password", array("allowed_values"=>null, "sql"=>'password', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("protocol", array("allowed_values"=>new ValueSetEnum("pop3,imap"), "display_style"=>'list', "sql"=>'protocol', "default_value"=>'pop3', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeInteger("port", array("allowed_values"=>null, "sql"=>'port', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("active", array("allowed_values"=>new ValueSetEnum("yes,no"), "display_style"=>'list', "sql"=>'active', "default_value"=>'yes', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
;
	...
	{
		if (($sAttCode == 'password') && (!UserRights::IsActionAllowed('MailInboxBase', UR_ACTION_MODIFY)))
		{
			return '*****';
		}
	...
	function DisplayBareRelations(WebPage $oPage, $bEditMode = false)
	{
		...
		if (!$bEditMode)
		{
			...
			$oPage->add('<p><form onsubmit="return false;">'.$sForm.'&nbsp;<button type="submit" id="mailbox_content_refresh">'.Dict::S('UI:Button:Refresh').'</button></form></p>');
