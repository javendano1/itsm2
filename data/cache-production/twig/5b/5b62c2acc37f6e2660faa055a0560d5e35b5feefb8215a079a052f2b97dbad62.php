...
class __TwigTemplate_af14250e586b725313946bc47552e1c4aae27701487a8c66bd8acddb90af9533 extends Twig_Template
{
...
\t<script type=\"text/javascript\" src=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "combodo.portal.base.absolute_url", array(), "array"), "html", null, true);
...
\t\t\t\t\t\$.ajax('";
        // line 344
        echo $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_browse_brick_mode", 1 => array("sBrickId" => (isset($context["sBrickId"]) ? $context["sBrickId"] : null), "sBrowseMode" => (isset($context["sBrowseMode"]) ? $context["sBrowseMode"] : null), "sDataLoading" => twig_constant("Combodo\\iTop\\Portal\\Brick\\AbstractBrick::ENUM_DATA_LOADING_FULL"))), "method");
        echo "')
\t\t\t\t\t.done(function(data)
\t\t\t\t\t{
\t\t\t\t\t\tbuildTree(data.data);
...
\t\t\t";
        // line 422
        if (( !(null === (isset($context["sSearchValue"]) ? $context["sSearchValue"] : null)) && ((isset($context["sSearchValue"]) ? $context["sSearchValue"] : null) != ""))) {
            // line 423
...
";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/browse/mode_tree.html.twig", "/home/alltic/public_html/itsm/env-production/itop-portal-base/portal/src/views/bricks/browse/mode_tree.html.twig");
    }
}
