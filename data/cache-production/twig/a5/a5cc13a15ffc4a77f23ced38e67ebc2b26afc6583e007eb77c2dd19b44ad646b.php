...
class __TwigTemplate_c4912c6ac2a0396e7c1f2d161e1dfaa0ff13784e53a66828a1f9cb664a95ca01 extends Twig_Template
{
...
\t";
        // line 11
        if ((array_key_exists("sMode", $context) &&  !(null === ($context["sMode"] ?? null)))) {
            echo "data-form-mode=\"";
            echo twig_escape_filter($this->env, ($context["sMode"] ?? null), "html", null, true);
            echo "\"";
        }
        // line 12
        echo "\t";
        if (($this->getAttribute(($context["form"] ?? null), "object_class", array(), "any", true, true) &&  !(null === $this->getAttribute(($context["form"] ?? null), "object_class", array())))) {
            echo "data-object-class=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["form"] ?? null), "object_class", array()), "html", null, true);
            echo "\"";
        }
        // line 13
        echo "\t";
        if (($this->getAttribute(($context["form"] ?? null), "object_id", array(), "any", true, true) &&  !(null === $this->getAttribute(($context["form"] ?? null), "object_id", array())))) {
            echo "data-object-id=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["form"] ?? null), "object_id", array()), "html", null, true);
            echo "\"";
        }
        // line 14
        echo "\t";
    ...
    public function block_pFormButtons($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute(($context["form"] ?? null), "buttons", array(), "any", true, true) && ($this->getAttribute($this->getAttribute(($context["form"] ?? null), "buttons", array(), "any", false, true), "actions", array(), "any", true, true) || $this->getAttribute($this->getAttribute(($context["form"] ?? null), "buttons", array(), "any", false, true), "links", array(), "any", true, true)))) {
            ...
            echo "\t\t\t\t<div class=\"form_btn_misc\">
                    ";
            // line 33
            $this->loadTemplate("itop-portal-base/portal/src/views/bricks/object/plugins_buttons.html.twig", "itop-portal-base/portal/src/views/bricks/object/mode_create.html.twig", 33)->display(array_merge($context, array("aButtons" => $this->getAttribute(($context["form"] ?? null), "buttons", array()))));
            // line 34
            echo "\t\t\t\t</div>
            ";
        }
...
\t\t";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/object/mode_create.html.twig", "C:\\xampp\\htdocs\\itsm\\env-production\\itop-portal-base\\portal\\src\\views\\bricks\\object\\mode_create.html.twig");
    }
}
