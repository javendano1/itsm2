						<?php
//
// File generated by ... on the 2020-06-17T23:04:30+0000
...
class Incident extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("resolution_code", array("allowed_values"=>new ValueSetEnum("assistance,other,software patch,training,hardware repair,system update,bug fixed,configuration,hardware change"), "display_style"=>'list', "sql"=>'resolution_code', "default_value"=>'assistance', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeInteger("tiempo_indisponibilidad", array("allowed_values"=>null, "sql"=>'tiempo_indisponibilidad', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("indisponibilidad", array("allowed_values"=>new ValueSetEnum("si,no"), "display_style"=>'list', "sql"=>'indisponibilidad', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'indisponibilidad' => OPT_ATT_HIDDEN,
					'tiempo_indisponibilidad' => OPT_ATT_HIDDEN,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'indisponibilidad' => OPT_ATT_MANDATORY | OPT_ATT_MUSTPROMPT,
					'tiempo_indisponibilidad' => OPT_ATT_MUSTPROMPT,
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'indisponibilidad' => OPT_ATT_READONLY,
					'tiempo_indisponibilidad' => OPT_ATT_READONLY,
  ...
  array (
    ...
    array (
      0 => 'resolution_code',
      1 => 'indisponibilidad',
      2 => 'tiempo_indisponibilidad',
      3 => 'solution',
      4 => 'time_spent',
      5 => 'user_satisfaction',
      6 => 'clarity_information',
      7 => 'time_required',
      8 => 'user_comment',
    ),
    'fieldset:Ticket:SLA' => 
