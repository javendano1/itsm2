...
class PC extends ConnectableCI
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("charger", array("allowed_values"=>null, "sql"=>'charger', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
