						<?php
//
// File generated by ... on the 2020-09-02T06:09:45+0000
...
abstract class PhysicalDevice extends FunctionalCI
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeDate("platform_date", array("allowed_values"=>null, "sql"=>'platform_date', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDate("last_maintenance", array("allowed_values"=>null, "sql"=>'last_maintenance', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeDate("next_maintenance", array("allowed_values"=>null, "sql"=>'next_maintenance', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
...
class Server extends DatacenterDevice
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeString("host_name", array("allowed_values"=>null, "sql"=>'host_name', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeString("ram", array("allowed_values"=>null, "sql"=>'ram', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
		MetaModel::Init_AddAttribute(new AttributeEnum("type_disc", array("allowed_values"=>new ValueSetEnum("hdd,ssd,hdd-ssd"), "display_style"=>'list', "sql"=>'type_disc', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "always_load_in_tables"=>false)));
